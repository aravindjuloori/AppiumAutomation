...
public class Ecommerce_tc1 extends BaseTest{
	...
	public void fillform() throws InterruptedException {
			 ...
			 * getAttribute("name"); System.out.println(toastMessage);
			 * Assert.assertEquals(toastMessage, "Please enter your name");
			 */
			
			
			  System.out.println(driver.findElement(By.id("com.androidsample.generalstore:id/radioMale")).getAttribute("checked"));
